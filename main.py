...
# يخدم الملفات الثابتة (مثل صورة الهيرو) مباشرة من مجلد static ضمن المشروع
# بدل رفعها لـ Supabase Storage - الملف لازم يكون موجود بمسار: static/office-hero.webp
...
<body class="min-h-screen">
    ...
    <div id="heroBg">
        <img src="/static/office-hero.webp" alt="مكتب عبدالله حريري للتوريد والشحن">
        <div class="heroOverlay"></div>
    </div>

    <!-- الهيدر: ثابت أعلى الصفحة، يعلو فوق صورة الهيرو دائماً -->
    <header class="sticky top-0 z-30 bg-slate-900/85 backdrop-blur-sm text-white shadow-md">
        <div class="p-4 flex justify-between items-center">
            <div>
                <h1 class="text-base font-bold text-amber-400">عبدالله حريري للتوريد والشحن الدولي من الصين</h1>
                <p class="text-xs text-slate-300">كافة خدمات الشراء والفحص والشحن من كوانزو وإيوو</p>
            </div>
        ...
        <div class="px-4 pb-3">
            <div class="relative">
                <input type="text" id="searchInput" oninput="handleSearchInput()"
                       ...
                       class="w-full bg-white text-gray-800 text-sm rounded-lg py-2 pr-9 pl-3 focus:outline-none focus:ring-2 focus:ring-amber-500">
